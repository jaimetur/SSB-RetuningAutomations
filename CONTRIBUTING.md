...
Before starting anything, take a look at the [Issues](https://github.com/jaimetur/SSB_RetuningAutomations/issues) tab to see if your idea or bug has already been reported.

If it hasn’t, feel free to [open a new issue](https://github.com/jaimetur/SSB_RetuningAutomations/issues/new/choose).
...
```bash
git clone https://github.com/jaimetur/SSB_RetuningAutomations.git
cd SSB_RetuningAutomations
```
